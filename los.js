// CFA Level II 2026 — Official Learning Outcome Statements (verbatim, parsed from
// the CFA Institute 2026 Level II Topic Outlines). Coverage marks map each module
// to app content. 10 topics, 45 modules, 370 LOS.
 ...
 "topics": [
   ...
   "modules": [
    {
     ...
     "coverage": "full",
     "note": "flashcards · exam Q3 · Regression Lab",
     "los": [
    ...
    {
     "title": "Extensions of Multiple Regression",
     "coverage": "partial",
     "note": "flashcards",
     "los": [
    ...
    },
    {
     ...
     "coverage": "full",
     "note": "flashcards · exams Q4–Q7 · ML Pipeline Builder · Data-Exploration Sorter",
     "los": [
  ...
  },
  {
   ...
   "modules": [
    ...
    {
     "title": "Environmental, Social, and Governance (ESG) Considerations in Investment Analysis",
     "coverage": "partial",
     "note": "flashcards",
     "los": [
   ...
   "modules": [
    {
     ...
     "coverage": "full",
     "note": "flashcards · Term Structure item set",
     "los": [
    ...
    },
    {
     ...
     "coverage": "full",
     "note": "flashcards · Callable/OAS item set",
     "los": [
   ...
   "modules": [
    {
     ...
     "coverage": "full",
     "note": "flashcards · Forwards/Swap item set",
     "los": [
    ...
    },
    {
     ...
     "coverage": "full",
     "note": "flashcards · BSM/Greeks item set",
     "los": [
  ...
  },
  {
   ...
   "modules": [
    {
     "title": "Introduction to Commodities and Commodity Derivatives",
     "coverage": "partial",
     "note": "flashcards",
     "los": [
    ...
    {
     "title": "Investments in Real Estate through Publicly Traded Securities",
     "coverage": "full",
     "note": "flashcards · REIT item set",
     "los": [
  ...
  },
  {
   ...
   "modules": [
    ...
    },
    {
     ...
     "coverage": "full",
     "note": "flashcards · Active/Fundamental-Law item set",
     "los": [
    ...
    {
     "title": "Exchange-Traded Funds: Mechanics and Applications",
     "coverage": "partial",
     "note": "flashcards",
     "los": [
  ...
  },
  {
   ...
   "modules": [
    ...
    {
     "title": "Application of the Code and Standards: Level II",
     "coverage": "full",
     "note": "flashcards · exam E1",
     "los": [
